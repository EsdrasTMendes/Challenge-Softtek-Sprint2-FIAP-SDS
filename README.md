...
-   `ROLE_COMPANY_ADMIN`: O Administrador de uma empresa cliente. Pode gerenciar usuários da sua própria empresa.
-   `ROLE_EMPLOYEE`: O Colaborador de uma empresa cliente. Usuário padrão que se cadastra pelo link da empresa.
...
-   [ ] Implementar rotas CRUD para as outras entidades (`CheckinDiario`, `QuestionarioSemanal`).
